...
There is a  game organised by a society, n friends are playing that game. 
In this game the friends sit in a circle and are numbered from 1 to n in 
clockwise order. Moving clockwise from the ith friend brings you to the (i+1)th 
friend for 1 <= i < n, and moving clockwise from the nth friend brings you 
to the 1st friend.
...
and repeat. Else, the last friend in the circle wins the game.
